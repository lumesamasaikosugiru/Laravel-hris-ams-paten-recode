...
class SkillIndex extends Component
{
    ...
    {
        return ['name' => 'required|max:255', 'category' => 'nullable|max:100', 'is_active' => 'boolean'];
    }
    ...
    {
        $this->reset(['editingId', 'name', 'category']);
        $this->is_active = true;
    ...
    public function delete(): void
    {
        ...
        Skill::findOrFail($this->deletingId)->delete();
        session()->flash('success', 'Skill dihapus.');
