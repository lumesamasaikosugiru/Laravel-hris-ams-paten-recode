    ...
    <div class="card overflow-hidden mb-1">
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input wire:model="place_of_birth" type="text"
                           class="input" placeholder="Kota kelahiran">
                </div>
                <div>
            ...
            <div class="border-t border-gray-100 pt-4">
                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Pendidikan Terakhir</p>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <input wire:model="last_education_major" type="text"
                               class="input" placeholder="Program studi">
                    </div>
                    <div>
                        <label class="form-label">Institusi</label>
                        <input wire:model="last_education_institution" type="text"
                               class="input" placeholder="Nama universitas/sekolah">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="border border-gray-200 rounded-xl p-4 relative">
                ...
                <div class="grid grid-cols-2 gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <input wire:model="educations.{{ $i }}.gpa"
                               type="number" step="0.01" min="0" max="4"
                               class="input" placeholder="3.50">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <input wire:model="educations.{{ $i }}.start_year"
                               type="number" placeholder="{{ now()->year - 4 }}"
                    ...
                    <div>
                        ...
                        <input wire:model="educations.{{ $i }}.end_year"
                               type="number" placeholder="{{ now()->year }}"
                               class="input">
                    </div>
                </div>
            </div>
            ...
            <div class="border border-gray-200 rounded-xl p-4 relative">
                ...
                <div class="grid grid-cols-2 gap-3 mb-3">
                    <div>
                        ...
                        <input wire:model="experiences.{{ $i }}.start_date" type="date" class="input">
                    </div>
                    <div>
                ...
                <div class="flex items-center gap-2 mb-3">
                    <input wire:model.live="experiences.{{ $i }}.is_current"
                           type="checkbox" id="current_{{ $i }}"
                           class="rounded border-gray-300 text-violet-600 w-4 h-4">
                    <label for="current_{{ $i }}" class="text-sm text-gray-600 cursor-pointer">
                ...
                <div>
                    ...
                    <textarea wire:model="experiences.{{ $i }}.description" rows="2"
                              class="input resize-none"
        ...
        <div class="p-6 space-y-4">
            <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-violet-400 transition">
                <svg class="w-8 h-8 text-gray-300 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                </svg>
                <label class="form-label text-center">Upload CV / Resume</label>
                <p class="text-xs text-gray-400 mb-3">Format: PDF, DOC, DOCX · Maks. 5MB</p>
                ...
                @error('cv_file')<p class="form-error mt-2">{{ $message }}</p>@enderror
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
            <button wire:click="prevTab"
                    class="btn-ghost {{ $activeTab === 'biodata' ? 'invisible' : '' }}">
                ← Sebelumnya
            </button>
