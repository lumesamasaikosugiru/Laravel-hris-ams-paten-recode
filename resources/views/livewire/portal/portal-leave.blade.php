<div class="p-4 space-y-4">
    ...
    <div class="portal-card p-5">
        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Saldo Cuti {{ now()->year }}</p>
        <div class="space-y-3">
    ...
    <div class="portal-card p-5 space-y-4">
        ...
        {{-- Info saldo --}}
        @if($selectedBalance)
        <div class="p-3 {{ $selectedBalance['remaining'] > 0 ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200' }} border rounded-xl text-xs">
            <div class="flex justify-between">
                <span class="text-gray-600">Sisa saldo</span>
                <span class="font-bold {{ $selectedBalance['remaining'] > 0 ? 'text-green-600' : 'text-red-600' }}">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                <label class="text-xs font-semibold text-gray-500 uppercase tracking-wide block mb-1.5">Mulai *</label>
            ...
            <div>
                <label class="text-xs font-semibold text-gray-500 uppercase tracking-wide block mb-1.5">Selesai *</label>
        ...
        <div>
            ...
            <input wire:model="document_file" type="file"
        ...
        <div class="divide-y divide-gray-100">
            ...
            <div class="px-5 py-3">
                <div class="flex items-start justify-between">
                    ...
                    <span class="status-chip text-xs
