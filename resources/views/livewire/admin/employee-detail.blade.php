<div class="space-y-5">
    ...
    <div class="card p-6">
        <div class="flex flex-col sm:flex-row sm:items-start gap-5">
            ...
            {{-- Avatar --}}
            <div class="w-20 h-20 rounded-full shrink-0 overflow-hidden flex items-center justify-center
            ...
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-4 mt-4 pt-4 border-t border-gray-100 text-xs">
                    ...
                    <div>
                        ...
                        <span class="font-medium {{ $employee->is_probation_overdue ? 'text-red-600' : 'text-amber-600' }}">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="card p-5">
                ...
                <div class="space-y-3 text-sm">
                    @foreach([
                        ...
                        ['Jenis Kelamin',   $employee->gender_label],
                        ...
                        ['Kewarganegaraan', $employee->nationality],
                    ] as [$label, $val])
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="card p-5">
                ...
                @php
                    $assignments = $employee->positionAssignments()
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-4 relative">
                            ...
                            <div class="w-7 h-7 rounded-full shrink-0 flex items-center justify-center z-10
                                        {{ $assign->is_active
                                            ? 'bg-violet-600 border-2 border-white shadow-md'
            ...
            <div class="card p-5">
                ...
                @php
                    $histories = $employee->statusHistories()
                        ->with('recordedBy')
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-lg bg-gray-50 text-sm">
                        <div class="shrink-0 mt-0.5">
                            <span class="badge {{ match($h->status) {
                                'active'     => 'badge-green',
        ...
        <div class="modal-box max-w-md" wire:click.stop>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    @error('assign_dept_id')<p class="form-error">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="form-label">Jabatan Baru <span class="text-red-500">*</span></label>
                    <select wire:model="assign_pos_id"
                            class="input @error('assign_pos_id') input-error @enderror"
                            {{ empty($assign_dept_id) ? 'disabled' : '' }}>
                        <option value="">{{ empty($assign_dept_id) ? '-- Pilih dept dulu --' : '-- Pilih Jabatan --' }}</option>
                        @foreach($assignPositions as $p)
                            <option value="{{ $p->id }}">{{ $p->name }}</option>
                        @endforeach
                    </select>
                    @error('assign_pos_id')<p class="form-error">{{ $message }}</p>@enderror
                </div>
                <div>
                    ...
                    @error('assign_start_date')<p class="form-error">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="form-label">Catatan</label>
                    <textarea wire:model="assign_notes" rows="2"
        ...
        <div class="modal-box max-w-md" wire:click.stop>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="cursor-pointer">
                            <input wire:model="probation_decision" type="radio"
                                   value="passed" class="sr-only peer">
                            <div class="p-3 border-2 rounded-xl text-center text-sm transition
                        ...
                        <label class="cursor-pointer">
                            <input wire:model="probation_decision" type="radio"
                                   value="failed" class="sr-only peer">
                            <div class="p-3 border-2 rounded-xl text-center text-sm transition
                ...
                <div class="p-3 bg-violet-50 border border-violet-200 rounded-lg">
                    <p class="text-xs text-violet-700 font-semibold mb-1">Preview NIPY yang akan diterbitkan:</p>
                    ...
                    <p class="text-xs text-violet-500 mt-1">
                        ...
                        + {{ \App\Services\NipyGenerator::getEducationCode($employee->last_education) }} (pendidikan)
                        + {{ \App\Services\NipyGenerator::getEmploymentCode($employee->is_guru, $employee->employee_type) }} (jenis)
                        + nomor urut otomatis
                    </p>
                </div>
                @endif
                ...
                <div>
                    ...
                    <textarea wire:model="probation_notes" rows="3"
                              class="input resize-none"
