...
class FatahillahStructureSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $smkypf1 = School::firstOrCreate(['code' => 'SMK1-FTH'], ['name' => 'SMK YP. Fatahillah 1 CLG', 'is_active' => true]);
        $smkypf2 = School::firstOrCreate(['code' => 'SMK2-FTH'], ['name' => 'SMK YP. Fatahillah 2', 'is_active' => true]);
        ...
        // ── Per Sekolah ──────────────────────────────────
        foreach ([$smkypf1, $smkypf2] as $school) {
