<div>
    ...
    <div class="card overflow-hidden mb-5">
        <div class="flex border-b border-gray-200 overflow-x-auto">
            @foreach([
                ['identity',   '1', 'Identitas'],
                ['contact',    '2', 'Kontak'],
                ['employment', '3', 'Kepegawaian'],
                ['education',  '4', 'Pendidikan'],
                ['assignment', '5', 'Jabatan'],
            ] as [$tab, $num, $label])
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="flex items-center gap-5">
                <div class="w-20 h-20 rounded-full bg-gray-100 border-2 border-gray-200 overflow-hidden shrink-0 flex items-center justify-center">
                    @if($photo)
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input wire:model="national_id" type="text"
                           class="input" placeholder="16 digit NIK KTP">
                </div>
            </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input wire:model="emergency_contact_name" type="text"
                               class="input" placeholder="Nama kontak">
                    </div>
                    <div>
                        <label class="form-label">No. Telepon</label>
                    ...
                    <div>
                        ...
                        <input wire:model="emergency_contact_relation" type="text"
                               class="input" placeholder="Istri, Orang Tua...">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    @error('contract_end')<p class="form-error">{{ $message }}</p>@enderror
                </div>
            </div>
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                ...
                <input wire:model="last_education_major" type="text"
                       class="input" placeholder="Contoh: Manajemen Pendidikan">
            </div>
            <div>
        ...
        @if($isEdit)
            <div class="p-6 text-center py-10">
                ...
                <p class="text-sm font-medium text-gray-500">Perubahan jabatan dikelola di halaman detail pegawai</p>
        ...
        @else
            <div class="p-6 space-y-4">
                <div class="p-3 bg-blue-50 border border-blue-200 rounded-lg text-xs text-blue-700">
                    Jabatan awal saat pertama kali ditambahkan. Mutasi dan promosi dikelola di halaman detail pegawai.
                </div>
                <div>
                    ...
                    <select wire:model.live="department_id"
                        ...
                        <option value="">{{ empty($school_id) ? '-- Pilih unit di tab Kepegawaian --' : '-- Pilih Departemen --' }}</option>
                ...
                <div>
                    ...
                    <select wire:model="position_id"
                        ...
                        <option value="">{{ empty($department_id) ? '-- Pilih departemen dulu --' : '-- Pilih Jabatan --' }}</option>
                ...
                <div>
                    ...
                    @error('assignment_start')<p class="form-error">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="form-label">Catatan</label>
                    <textarea wire:model="assignment_notes" rows="2"
                              class="input resize-none"
