        ...
        <aside id="sidebar" class="bg-sidebar w-64 flex flex-col shrink-0 shadow-xl transition-all duration-200">
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
                ...
                @can('attendance.report')
                    ...
                    @php
                        $offsitePending = \App\Livewire\Admin\OffsiteApproval::pendingCount();
                    @endphp
                    <a href="{{ route('admin.offsite-approvals') }}"
                        ...
                        <span>Kegiatan Luar</span>

                        {{-- Badge counter — hanya muncul jika ada yang pending --}}
                        @if ($offsitePending > 0)
                            <span
                                class="ml-auto bg-yellow-400 text-yellow-900 text-xs font-bold px-1.5 py-0.5 rounded-full leading-none">
                                {{ $offsitePending > 99 ? '99+' : $offsitePending }}
                            </span>
                        @endif
                    </a>
                @endcan
