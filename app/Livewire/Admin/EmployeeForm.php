...
class EmployeeForm extends Component
{
    ...
    // Status default AKTIF untuk tambah manual
    ...
    public function mount(?int $employeeId = null): void
    {
        if ($employeeId) {
            ...
            // Tambah manual: NIK diisi HR sendiri (bukan auto TMP-)
            $this->status           = 'active';
        }
    }
    ...
    public function save(): void
    {
        ...
        DB::transaction(function () {
            ...
            $data = [
                ...
                'status'         => $this->status,
                // Pegawai manual: tidak ada masa percobaan
            ...
            if ($this->isEdit) {
                ...
                PositionAssignment::create([
                    ...
                    'is_active'     => true,
                    'type'          => 'assignment',
                    'notes'         => $this->assignment_notes ?: 'Penugasan awal.',
                ]);
